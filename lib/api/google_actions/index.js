  ...
  api.post('/google_actions', ctx.authorization.isPermitted('api:*:read'), function (req, res, next) {
    ...
    console.log('req: ',req.body);
     ...
     if(locale){
      ...
      console.log('languageCode: ',req.body.queryResult.languageCode);
      console.log('locale: ',locale);

    }

    var handler = ctx.google_actions.getIntentHandler(req.body.queryResult.intent.displayName, req.body.queryResult.parameters.metric);
    if (handler){
