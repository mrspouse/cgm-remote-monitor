...
function init () {
  ...
  google_actions.configureIntentHandler = function configureIntentHandler(intent, handler, metrics) {
  ...
  google_actions.getIntentHandler = function getIntentHandler(intentName, metric) {
  ...
  google_actions.addToRollup = function(rollupGroup, handler, rollupName) {
  ...
  google_actions.getRollup = function(rollupGroup, sbx, slots, locale, callback) {
  ...
  google_actions.buildSpeechletResponse = function buildSpeechletResponse(output, expectUserResponse) {
